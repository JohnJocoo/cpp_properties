...
struct UnwrapIfProperty // common case (not a property)
{
  ...
  static constexpr const Type& forward( const Type& value ) noexcept
  {
    return value;
  }

  static constexpr Type&& forward( Type&& value ) noexcept
  {
  ...
  // read-write HoldingProperty - allow move from
{
  ...
  static constexpr const Type& forward( const Property& value ) noexcept
  {
    return value.cref();
  }

  static constexpr Type&& forward( Property&& value ) noexcept
  {
